    ...
    >
      <div className="max-w-content mx-auto px-4 sm:px-10 md:px-14 py-16">
        <div className="grid md:grid-cols-12 gap-10">
          <motion.div variants={fadeUp} className="md:col-span-6 space-y-5">
            <p className="font-mono text-sm text-blue_primary">
              <span className="text-yellow_primary">{"//"}</span> contact
            </p>
            <h3 className="text-3xl md:text-4xl font-bold text-white_primary">
              Have something to build?
            </h3>
            <p className="text-gray-400 max-w-md leading-relaxed">
              I&apos;m open to freelance work, internships and collaborations. Drop a
        ...
        >
          <p className="text-sm text-gray-500 font-mono">
            © {year} Toandro Mananjara — all rights reserved.
          </p>
          <a
            href="#home"
